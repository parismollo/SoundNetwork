...
\copy review(id, note, user_id, event_user_id) FROM 'CSV/review.csv' DELIMITER ',' CSV HEADER;
\copy comment(content, review_id) FROM 'CSV/comment.csv' DELIMITER ',' CSV HEADER;
\copy action(id, type, user_id, event_id) FROM 'CSV/action.csv' DELIMITER ',' CSV HEADER;
\copy tags(name, is_parent) FROM 'CSV/tag.csv' DELIMITER ',' CSV HEADER;
